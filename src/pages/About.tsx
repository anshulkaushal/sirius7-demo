...
const leaders = [
  ...
  { name: "Pratheek", role: "Oracle Cloud SME & OCI Architect", photo: pratheekPhoto, imgClass: "object-top scale-110", bio: "Pratheek is an Oracle Cloud SME and OCI Architect with 17+ years of experience across ERP, cloud and analytics ecosystems. He specialises in Oracle Fusion, OCI architecture and data analytics, helping organisations deliver scalable, high-performance solutions.\n\nAt Sirius7, Pratheek leads Oracle and data capabilities, and also serves as a Board Member and Secretary of NZOUG, supporting Oracle cloud adoption across New Zealand." },
];
