...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/50 shadow-sm relative overflow-visible">
      {/* Electric blue spark line */}
      <div className="absolute bottom-0 left-0 right-0 h-[2px]">
        <div className="h-full w-[80px] bg-gradient-to-r from-transparent via-primary to-transparent animate-[spark-slide_3s_linear_infinite] opacity-80" />
      </div>
